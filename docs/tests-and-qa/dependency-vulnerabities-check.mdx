---
<<<<<<< HEAD:pages/dependency-vulnerabities-check.md
layout: default
title: 依存関係の脆弱性チェック
...
>>>>>>> be9dc09c024a35e21e9637afdb55a6d53991f8d2:docs/tests-and-qa/dependency-vulnerabities-check.mdx
...
## What to do if you detect a vulnerability in one of JHipster's dependencies
>>>>>>> be9dc09c024a35e21e9637afdb55a6d53991f8d2:docs/tests-and-qa/dependency-vulnerabities-check.mdx
...
Since version 6, NPM includes a security audit by default for each dependency installation. Check the [About security audits](https://docs.npmjs.com/getting-started/running-a-security-audit) page for more information.
>>>>>>> be9dc09c024a35e21e9637afdb55a6d53991f8d2:docs/tests-and-qa/dependency-vulnerabities-check.mdx
