...
## Quick start
>>>>>>> be9dc09c024a35e21e9637afdb55a6d53991f8d2:docs/core-tasks/creating-an-app.mdx
...
=======
Answer the questions asked by the generator to create an application tailored to your needs. Those options are described in [the next section](#questions-asked-when-generating-an-application).
>>>>>>> be9dc09c024a35e21e9637afdb55a6d53991f8d2:docs/core-tasks/creating-an-app.mdx
...
If you are using Maven and changed front end files after first run of the `./mvnw` command then you must run `./mvnw -Pwebapp` to see the latest front end version (Gradle detects front end changes automatically and recompiles front end if needed).
...
=======
Your type of application depends on whether you wish to use a microservices architecture or not. A full explanation on microservices is [available here](/microservices-architecture/), if unsure use the default "Monolithic application".
>>>>>>> be9dc09c024a35e21e9637afdb55a6d53991f8d2:docs/core-tasks/creating-an-app.mdx
...
=======
You can find more information on our [securing your application](/security/) page.
>>>>>>> be9dc09c024a35e21e9637afdb55a6d53991f8d2:docs/core-tasks/creating-an-app.mdx
...
- [Neo4j](/using-neo4j/)
- No database (only available when using a [microservice application](/microservices-architecture/) with JWT authentication)
>>>>>>> be9dc09c024a35e21e9637afdb55a6d53991f8d2:docs/core-tasks/creating-an-app.mdx
...
=======
If you want to use Oracle, you might need to be aware of current limitations when [using Oracle database](/using-oracle/).
>>>>>>> be9dc09c024a35e21e9637afdb55a6d53991f8d2:docs/core-tasks/creating-an-app.mdx
...
*   The same database as the one you chose for production: it's a bit more complex to set up, but it should be better in the end to work on the same database as the one you will use in production. This is also the best way to use liquibase-hibernate as described in [the development guide](/development/).
>>>>>>> be9dc09c024a35e21e9637afdb55a6d53991f8d2:docs/core-tasks/creating-an-app.mdx
...
=======
This option lets you do [API-first development](/doing-api-first-development) for your application by integrating the [Swagger-Codegen](https://github.com/swagger-api/swagger-codegen) into the build.
>>>>>>> be9dc09c024a35e21e9637afdb55a6d53991f8d2:docs/core-tasks/creating-an-app.mdx
...
=======
[Elasticsearch](https://github.com/elastic/elasticsearch) will be configured using Spring Data Elasticsearch. You can find more information on our [Elasticsearch guide](/using-elasticsearch/).
>>>>>>> be9dc09c024a35e21e9637afdb55a6d53991f8d2:docs/core-tasks/creating-an-app.mdx
...
=======
Use [Apache Kafka](/using-kafka/) as a publish/subscribe message broker.
>>>>>>> be9dc09c024a35e21e9637afdb55a6d53991f8d2:docs/core-tasks/creating-an-app.mdx
...
=======
Use [Apache Pulsar](/using-pulsar/) as a publish/subscribe message broker.
>>>>>>> be9dc09c024a35e21e9637afdb55a6d53991f8d2:docs/core-tasks/creating-an-app.mdx
...
=======
You can find more information on our ["Running tests" guide](/running-tests/).
>>>>>>> be9dc09c024a35e21e9637afdb55a6d53991f8d2:docs/core-tasks/creating-an-app.mdx
