...
Angular is using TypeScript instead of JavaScript, and as a result some specific tooling is necessary to work efficiently with it. Our [development](/development) workflow for an Angular 2+ application is as below.
>>>>>>> be9dc09c024a35e21e9637afdb55a6d53991f8d2:docs/development/using-angular.mdx
...
Using the [entity sub-generator](/creating-an-entity/) to create a new entity called `Foo` generates the following front-end files under `src/main/webapp`:
...
=======
You can use `ng build` to build your front-end, but we still recommend to use the provided NPM scripts such as `npm start`, `npm run build`, etc. Check our ["using in development" documentation](/development/) and our ["using in production" documentation](/production/).
>>>>>>> be9dc09c024a35e21e9637afdb55a6d53991f8d2:docs/development/using-angular.mdx
