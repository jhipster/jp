---
<<<<<<< HEAD:pages/jhipster-registry.md
layout: default
title: JHipsterレジストリ
...
**deprecated** - Use Consul instead

>>>>>>> be9dc09c024a35e21e9637afdb55a6d53991f8d2:docs/microservices/jhipster-registry.mdx
...
we use `jhipster.security.authentication.jwt.secret` in this documentation. More information on those properties is available in our [security documentation](/security/).
>>>>>>> be9dc09c024a35e21e9637afdb55a6d53991f8d2:docs/microservices/jhipster-registry.mdx
...
=======
Please read our [Docker Compose documentation](/docker-compose/) for more information on using the JHipster Registry with Docker Compose.
>>>>>>> be9dc09c024a35e21e9637afdb55a6d53991f8d2:docs/microservices/jhipster-registry.mdx
...
=======
Please read [the "microservices in production" documentation](/microservices-in-production/) to learn how to deploy the JHipster Registry to Cloud Foundry or to Heroku.
...
=======
To migrate your applications, you can use the [JHipster upgrade sub-generator](/upgrading-an-application/).
>>>>>>> be9dc09c024a35e21e9637afdb55a6d53991f8d2:docs/microservices/jhipster-registry.mdx
