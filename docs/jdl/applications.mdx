...
|クライアントフレームワーク    |Angular             |Angular, React, Vue, Svelte, なし                                                                 |-                                                                                                           |
|Nodeパッケージマネージャー      |npm                 |npm                                                                                                     |-                                                                                                           |
...
|データベースタイプ           |sql                 |sql, mongodb, cassandra, couchbase, neo4j, なし                                                                           |該当なし                                                                                                    |
...
|testFrameworks      |[]                  |cypress, cucumber, gatling                                                                                              |中括弧は必須です                                                                                                |
