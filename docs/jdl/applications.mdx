...
|クライアントフレームワーク           |angular             |angular, react, vue, svelte, no                                                                                         |-                                                                                                           |
|Node.jsパッケージマネージャー  |npm                 |npm                                                                                                                     |-                                                                                                           |
...
|データベースタイプ        |SQL                 |SQL, MongoDB, Cassandra, Couchbase, Neo4j, なし                                                                           |-                                                                                                           |
...
|testFrameworks      |[]                  |cypress, cucumber, gatling                                                                                              |波括弧は必須です                                                                                            |
