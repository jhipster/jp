...
slug: 2026年2月4日のJHipsterリリース9.0.0ベータ3ドットHTML
displayed_sidebar: ドキュメントサイドバー
sidebar_class_name: 隠れた
---

# JHipsterリリース v9.0.0-beta.3

`9.0.0-beta.3` リリースが利用可能になりました！このリリースには、[9.0.0-beta.2](https://github.com/jhipster/generator-jhipster/releases/tag/v9.0.0-beta.2)以降、[65件のクローズされたイシューとプルリクエスト](https://github.com/jhipster/generator-jhipster/issues?q=is:closed+milestone:9.0.0-beta.3)が含まれています。
...
- **9.0.0-beta.2** は、JDLファイルの解析時に`Maximum call stack size exceeded`エラーを引き起こしたため、非推奨となりました ([#32116](https://github.com/jhipster/generator-jhipster/issues/32116))

代わりにこの`9.0.0-beta.3`リリースをご利用ください。

:::

## beta.3での修正

- **chevrotainの依存関係を修正** ([#32130](https://github.com/jhipster/generator-jhipster/pull/32130)) - beta.2に影響を与えたJDLファイルの解析時の`Maximum call stack size exceeded`エラーを解決します
...
- スタンドアロンコンポーネントを優先し、SharedModule/CommonModuleを削除しました ([#31623](https://github.com/jhipster/generator-jhipster/pull/31623), [#31695](https://github.com/jhipster/generator-jhipster/pull/31695))

### プラットフォームとツールチェーンの更新
- **Java 17のサポートを終了**: Java 21が最小要件バージョンとなりました ([#31903](https://github.com/jhipster/generator-jhipster/pull/31903))
- **Node 20のサポートを終了**: ネイティブTypeScriptサポートを備えたNode 22+が必須となりました ([#31845](https://github.com/jhipster/generator-jhipster/pull/31845))
...
詳細については、GitHubの[9.0.0-beta.3](https://github.com/jhipster/generator-jhipster/releases/tag/v9.0.0-beta.3)リリースノートをご覧ください。
...
より高度なアップグレード機能には、[migrateブループリント](https://github.com/jhipster/generator-jhipster-migrate)も利用できます。
...
プロジェクトをアップグレードするには、まず`node_modules`フォルダを削除し、次に以下を実行する必要があります：
