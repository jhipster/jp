...
:::warning 以前のベータリリースは問題がありました

- **9.0.0-beta.1** は、グローバルインストール時にCLIが`Cannot find package 'yeoman-test'`で失敗したため、非推奨となりました ([#32114](https://github.com/jhipster/generator-jhipster/issues/32114))
...
代わりに、この `9.0.0-beta.3` リリースをご利用ください。
