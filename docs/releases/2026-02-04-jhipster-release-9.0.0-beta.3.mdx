...
slug: 2026年2月4日のJHipster 9.0.0-beta.3リリースに関するページ
...
- **chevrotain依存関係の修正** ([#32130](https://github.com/jhipster/generator-jhipster/pull/32130)) - beta.2に影響を与えたJDLファイルのパース時の `Maximum call stack size exceeded` エラーを解決します
- **yeoman-testパッケージングの修正** ([#32122](https://github.com/jhipster/generator-jhipster/pull/32122)) - beta.1に影響を与えた `Cannot find package 'yeoman-test'` エラーを解決します
...
エンティティサブジェネレーターを再度実行することで、エンティティを1つずつ更新することもできます。例えば、エンティティ名が _Foo_ の場合、次を使用します：
