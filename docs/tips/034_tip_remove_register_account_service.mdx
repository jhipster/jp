...
* ___2.1.2___ `src\main\webapp\app\account\account.module.ts` に移動して、以下の行を削除します:
...
* ___2.1.6___ `src\main\webapp\app\shared\login\login.component.html` を開き、以下のブロックを削除します。
...
* ___2.1.8___ メッセージファイルを削除する: `src\main\webapp\i18n\ ... \register.json`
