...
__ヒント提供元：[@apuntandoanulo](https://github.com/apuntandoanulo) および更新者：[@juandbc](https://github.com/juandbc)__
...
* ___2.1.1___ `src\main\webapp\app\account`
  - `register`フォルダー全体を削除します。これには以下が含まれます： `register.component.html`、`register.component.ts`、`register.route.ts`、`register.service.ts`

* ___2.1.2___ `src\main\webapp\app\account\account.module.ts` に移動し、以下の行を削除してください:
  - `import { RegisterComponent } from './register/register.component'; `
  - _declarations_ array -> `RegisterComponent`

* ___2.1.3___ `src\main\webapp\app\account\account.route.ts` に移動し、以下の行を削除します。
...
* ___2.1.7___ `src\main\webapp\app\shared\login\login.component.ts` に移動し、以下のブロックを削除してください。
...
* ___2.1.9___ `src\test\javascript\spec\app\account`
  - フォルダー `register` (これには `register.component.spec.ts` が含まれます) をすべて削除します。

### 2.2 Vue

* ___2.2.1___ フォルダー `src/main/webapp/app/account/register` (これには `register.component.spec.ts`、`register.component.ts`、`register.service.ts`、`register.vue` が含まれます) をすべて削除します。
