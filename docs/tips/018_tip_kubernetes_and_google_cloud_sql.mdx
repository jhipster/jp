---
<<<<<<< HEAD:tips/018_tip_kubernetes_and_google_cloud_sql.md
layout: default
...
using the [Kubernetes sub-generator](/kubernetes), the default behaviour is to create a Google Compute
Engine VM for the database.
>>>>>>> be9dc09c024a35e21e9637afdb55a6d53991f8d2:docs/tips/018_tip_kubernetes_and_google_cloud_sql.mdx
...
=======
First of all run the [Kubernetes sub-generator](/kubernetes). Reply to the questions as usual but let us
