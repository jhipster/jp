---
<<<<<<< HEAD:modules/extending_and_customizing.md
layout: default
title: Blueprintの基本
...
>>>>>>> be9dc09c024a35e21e9637afdb55a6d53991f8d2:docs/modules/extending-and-customizing.mdx
...
=======
To make your blueprint available in [the JHipster marketplace](/modules/marketplace), you need to make sure you have the two keywords `yeoman-generator` and `jhipster-blueprint` in your published npm `package.json`.
