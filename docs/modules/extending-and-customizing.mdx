...
Blueprintを[JHipsterマーケットプレイス](/modules/marketplace/)で利用できるようにするには、公開されているnpm`package.json`に2つのキーワード`yeoman-generator`と`jhipster-blueprint`があることを確認する必要があります。
