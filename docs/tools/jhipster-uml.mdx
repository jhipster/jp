...
>>>>>>> be9dc09c024a35e21e9637afdb55a6d53991f8d2:docs/tools/jhipster-uml.mdx
...
=======
To learn more about the JDL, head [here](/jdl/intro/).

JHipster-UML is a JHipster sub-project that can be used as a replacement to using the [entity sub-generator](/creating-an-entity). The idea is that it is much easier to [manage relationships](/managing-relationships) using a visual tool than with the classical Yeoman questions and answers.
>>>>>>> be9dc09c024a35e21e9637afdb55a6d53991f8d2:docs/tools/jhipster-uml.mdx
